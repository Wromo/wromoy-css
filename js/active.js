(function () {
    ...
    var wromoyWindow = $(window);

    // :: Preloader
    wromoyWindow.on('load', function () {
    ...
    // :: Dropdown Menu
    $(".sidenav-nav").find("li.wromoy-dropdown-menu").append("<div class='dropdown-trigger-btn'><i class='lni lni-chevron-down'></i></div>");
    ...
    // :: Tooltip 
    var tooltipWromoy = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
    var tooltipList = tooltipWromoy.map(function (tooltip) {
        return new bootstrap.Tooltip(tooltip);
    });

    // :: Toast 
    var toastWromoy = [].slice.call(document.querySelectorAll('.toast'));
    var toastList = toastWromoy.map(function (toast) {
